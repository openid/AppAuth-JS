...
export declare abstract class AuthorizationRequestHandler {
     ...
     */
    completeAuthorizationRequestIfPossible(useHash?: boolean): Promise<void>;
    /**
     ...
     * if not ready.
     */
    protected abstract completeAuthorizationRequest(useHash?: boolean): Promise<AuthorizationRequestResponse | null>;
}
